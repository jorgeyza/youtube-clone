      ...
      <Container>
        ...
        <Paper withBorder shadow='md' p={30} mt={30} radius='md'>
          <form onSubmit={form.onSubmit((values) => mutation.mutate(values))}>
            <Stack>
              <TextInput label='Email' placeholder='jorge@example.com' required {...form.getInputProps('email')} />
              <TextInput label='Username' placeholder='jorgeyza' required {...form.getInputProps('username')} />
              <PasswordInput
                label='Password'
